    ...
    public static class MapTerrainProjectBaselineAuditService
    {
        ...
        public static MapTerrainProjectBaselineAuditDelivery Run(ExternalContentConfiguration configuration, int maxRoots = 1024, int maxEntries = 500000)
        {
            ...
            try
            {
                ...
                MapTerrainProjectBaselineAuditStatus status = candidates == 0 ? MapTerrainProjectBaselineAuditStatus.CompleteWithNoCandidates : failures == 0 ? MapTerrainProjectBaselineAuditStatus.Complete : MapTerrainProjectBaselineAuditStatus.CompleteWithFailures;
